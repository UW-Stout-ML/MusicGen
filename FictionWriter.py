...
class FictionData(Dataset):
    ...
    def __init__(self, max_length=5, random_sample=True):
    ...
    def __getitem__(self, idx):
        ...
        if self.random_sample:
            prefix_len = random.randint(2, min(len(sentence), self.max_length))
            sentence = sentence[:prefix_len]
